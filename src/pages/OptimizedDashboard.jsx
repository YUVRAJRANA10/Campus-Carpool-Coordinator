...
import { useRidesContext } from '../contexts/OptimizedRideContext'
...
const BookingRequestCard = React.memo(({ request, onRespond }) => {
...
const Dashboard = () => {
  ...
  const recentActivities = useMemo(() => {
    ...
    bookingRequests?.slice(0, 2).forEach(request => {
      activities.push({
            ...
            <nav className="-mb-px flex space-x-8">
              {[
                ...
                >
                  ...
                  {label}
                  {key === 'requests' && bookingRequests?.length > 0 && (
          ...
          {activeTab === 'requests' && (
            <div className="lg:col-span-3">
              ...
              >
                ...
                {isLoading('respondToBooking') && <LoadingSpinner />}
...
export default withPerformanceTracking(Dashboard, 'Dashboard')